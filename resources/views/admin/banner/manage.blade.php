    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body list-grid">
                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllBanner','Delete these Banner\'s details?','Are you sure you want to delete these Banner\'s details?');">
                                        Delete</button>
                ...
                <form method="post" id="deleteAllBanner">

                    <div class="data-tables">
                        <table id="bannerTable" class="text-center">
                            ...
                            <tbody>
                                ...
                                <tr id="item{{$value->id}}">
                                    ...
                                    <td>@isset($value->bannerHeading){{$value->bannerHeading}}@else NA @endif</td>
                                    <td>@isset($value->bannerText){{$value->bannerText}}@else NA @endif</td>
                                    <td>@isset($value->bannerSlogan){{$value->bannerSlogan}}@else NA @endif</td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('banner.edit', $value->id)}}">Edit</a>
                                            <a class="dropdown-item" onclick="deleteRecord('{{$value->id}}','Delete this Banner details?','Are you sure you want to delete this Banner details?');">Delete</a>
                                        </div>
                                    </td>
