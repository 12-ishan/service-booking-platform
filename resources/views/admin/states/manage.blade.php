    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body list-grid">
                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllStates','Delete these States\'s details?','Are you sure you want to delete these State\'s details?');">
                                        Delete</button>
                                ...
                                <div class="col-6 right-control">
                                    ...
                                    <!-- <a href="{{ url('/console/state') }}"> -->
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Refresh</button>
                                    </a>

                                    <a href="{{route('state.create')}}">
                                    <!-- <a href="{{ url('/console/state/create') }}"> -->
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Add States</button>
                                    </a>
                ...
                <form method="post" id="deleteAllStates">

                    <div class="data-tables">
                        <table id="statesTable" class="text-center">
                                ...
                                <tr id="item{{$value->id}}">
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('state.edit', $value->id)}}">Edit</a>
                                            <a class="dropdown-item" onclick="deleteRecord('{{$value->id}}','Delete this State details?','Are you sure you want to delete this State details?');">Delete</a>
                                        </div>
                                    </td>
