    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body list-grid">
                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllSubject','Delete these Subject\'s details?','Are you sure you want to delete these Subject\'s details?');">
                                        Delete</button>
                                ...
                                <div class="col-6 right-control">
                                    ...
                                    <!-- <a href="{{ url('/console/subject') }}"> -->
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Refresh</button>
                                    </a>

                                    <a href="{{route('subject.create')}}">
                                    <!-- <a href="{{ url('/console/subject/create') }}"> -->
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Add Subject</button>
                                    </a>
                ...
                <form method="post" id="deleteAllSubject">

                    <div class="data-tables">
                        <table id="subjectTable" class="text-center">
                                ...
                                <tr id="item{{$value->id}}">
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('subject.edit', $value->id)}}">Edit</a>
                                            <a class="dropdown-item" onclick="deleteRecord('{{$value->id}}','Delete this Subject details?','Are you sure you want to delete this Subject details?');">Delete</a>
                                        </div>
                                    </td>
