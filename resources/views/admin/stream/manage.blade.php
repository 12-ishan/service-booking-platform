    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body list-grid">
                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllStream','Delete these Stream\'s details?','Are you sure you want to delete these stream\'s details?');">
                                        Delete</button>
                                ...
                                <div class="col-6 right-control">
                                    ...
                                    <a href="{{route('stream.create')}}">
                                        ...
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Add State</button>
                                    </a>
                ...
                <form method="post" id="deleteAllStream">

                    <div class="data-tables">
                        <table id="streamTable" class="text-center">
                                ...
                                <tr id="item{{$value->id}}">
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('stream.edit', $value->id)}}">Edit</a>
                                            <a class="dropdown-item" onclick="deleteRecord('{{$value->id}}','Delete this stream details?','Are you sure you want to delete this stream details?');">Delete</a>
                                        </div>
                                    </td>
