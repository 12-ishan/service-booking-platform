                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllOurServices','Delete these our services\'s details?','Are you sure you want to delete these our services\'s details?');">
                                        Delete</button>
                                ...
                                <div class="col-6 right-control">
                                    ...
                                    <a href="{{route('our-services.create')}}">
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Add Services</button>
                                    </a>
...
<!--                                     <a href="{{route('our-services.create')}}">
 -->                                    <!-- <a href="{{ url('/console/ourServices/create') }}"> -->
                ...
                <form method="post" id="deleteAllOurServices">

                    <div class="data-tables">
                        <table id="ourServicesTable" class="text-center">
                                   ...
                                   <td>@isset($value->title)
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('our-services.edit', $value->id)}}">Edit</a>
                                            <a class="dropdown-item" onclick="deleteRecord('{{$value->id}}','Delete this our services details?','Are you sure you want to delete this our services details?');">Delete</a>
                                        </div>
                                    </td>
