    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body list-grid">
                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllCity','Delete these City\'s details?','Are you sure you want to delete these city\'s details?');">
                                        Delete</button>
                                ...
                                <div class="col-6 right-control">
                                    ...
                                    <a href="{{route('city.create')}}">
                                        ...
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Add City</button>
                                    </a>
                ...
                <form method="post" id="deleteAllCity">

                    <div class="data-tables">
                        <table id="cityTable" class="text-center">
                                ...
                                <tr id="item{{$value->id}}">
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" onclick="deleteRecord('{{$value->id}}','Delete this city details?','Are you sure you want to delete this city details?');">Delete</a>
                                        </div>
                                    </td>
