    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body list-grid">
                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllQuestion','Delete these Question\'s details?','Are you sure you want to delete these Question\'s details?');">
                                        Delete</button>
                                ...
                                <div class="col-6 right-control">
                                    ...
                                    <!-- <a href="{{ url('/console/question') }}"> -->
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Refresh</button>
                                    </a>

                                    <a href="{{route('question.create')}}">
                                    <!-- <a href="{{ url('/console/question/create') }}"> -->
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Add Question</button>
                                    </a>
                ...
                <form method="post" id="deleteAllQuestion">

                    <div class="data-tables">
                        <table id="questionTable" class="text-center">
 ...
 -->                                    <th>Status</th>  
                            ...
                            <tbody>
                                ...
                                <tr id="item{{$value->id}}">
                                    ...
                                    <td>@isset($value->question){{$value->question}}@else NA @endif</td>
 ...
 -->                             
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" onclick="deleteRecord('{{$value->id}}','Delete this Question details?','Are you sure you want to delete this Question details?');">Delete</a>
                                        </div>
                                    </td>
