    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body list-grid">
                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllTopic','Delete these topic\'s details?','Are you sure you want to delete these topic\'s details?');">
                                        Delete</button>
                                ...
                                <div class="col-6 right-control">
                                    ...
                                    <!-- <a href="{{ url('/console/topic') }}"> -->
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Refresh</button>
                                    </a>

                                    <a href="{{route('topic.create')}}">
                                    <!-- <a href="{{ url('/console/topic/create') }}"> -->
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Assign Topic</button>
                                    </a>
                ...
                <form method="post" id="deleteAllTopic">

                    <div class="data-tables">
                        <table id="topicTable" class="text-center">
                                ...
                                <tr id="item{{$value->id}}">
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('topic.edit', $value->id)}}">Edit</a>
                                            <a class="dropdown-item" onclick="deleteRecord('{{$value->id}}','Delete this Topic details?','Are you sure you want to delete this topic details?');">Delete</a>
                                        </div>
                                    </td>
