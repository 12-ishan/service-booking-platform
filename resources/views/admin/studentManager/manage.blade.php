    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body list-grid">
                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllStudent','Delete these Student\'s details?','Are you sure you want to delete these student\'s details?');">
                                        Delete</button>
                                ...
                                <div class="col-6 right-control">
                                    ...
                                    <a href="{{route('studentManager.index')}}">

                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Refresh</button>
                                    </a>

                                    <a href="{{route('studentManager.create')}}">
                                   
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Add Student</button>
                                    </a>
                ...
                <form method="post" id="deleteAllStudent">

                    <div class="data-tables">
                        <table id="studentManagerTable" class="text-center">
                            ...
                            <tbody>
                                ...
                                <tr id="item{{$value->id}}">
                                    ...
                                    <td>@isset($value->first_name){{$value->first_name}}@else NA @endif</td>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('studentManager.edit', $value->id)}}">Edit</a>
                                            <a class="dropdown-item" onclick="deleteRecord('{{$value->id}}','Delete this student details?','Are you sure you want to delete this student details?');">Delete</a>
                                        </div>
                                    </td>
