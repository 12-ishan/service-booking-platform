    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body list-grid">
                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllDegree','Delete these Degree\'s details?','Are you sure you want to delete these degree\'s details?');">
                                        Delete</button>
                                ...
                                <div class="col-6 right-control">
                                    ...
                                    <a href="{{route('degree.create')}}">
                                   
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Add Degree</button>
                                    </a>
                ...
                <form method="post" id="deleteAllDegree">

                    <div class="data-tables">
                        <table id="degreeTable" class="text-center">
                                ...
                                <tr id="item{{$value->id}}">
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('degree.edit', $value->id)}}">Edit</a>
                                            <a class="dropdown-item" onclick="deleteRecord('{{$value->id}}','Delete this degree details?','Are you sure you want to delete this degree details?');">Delete</a>
                                        </div>
                                    </td>
