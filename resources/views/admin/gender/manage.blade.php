    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body list-grid">
                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllGender','Delete these Gender\'s details?','Are you sure you want to delete these Gender\'s details?');">
                                        Delete</button>
                                ...
                                <div class="col-6 right-control">
                                    ...
                                    <a href="{{route('gender.create')}}">
                                        ...
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Add Gender</button>
                                    </a>
                ...
                <form method="post" id="deleteAllGender">

                    <div class="data-tables">
                        <table id="genderTable" class="text-center">
                                ...
                                <tr id="item{{$value->id}}">
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('gender.edit', $value->id)}}">Edit</a>
                                            <a class="dropdown-item" onclick="deleteRecord('{{$value->id}}','Delete this Gender details?','Are you sure you want to delete this Gender details?');">Delete</a>
                                        </div>
                                    </td>
