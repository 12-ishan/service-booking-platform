    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body list-grid">
                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllState','Delete these State\'s details?','Are you sure you want to delete these state\'s details?');">
                                        Delete</button>
                ...
                <form method="post" id="deleteAllState">

                    <div class="data-tables">
                        <table id="stateTable" class="text-center">
