                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="Activatefrm" method="post"
                            action="{{url('teacher-meeting/activate/update')}}/{{ $meeting->id}}" enctype='multipart/form-data'>
                                ...
                                <div class="col-4 mt-5">
                                    <div class="form-group">
                                       ...
                                       <select class="form-control selectpicker" id="meetingStatus" name="meetingStatus" data-live-search="true">
                                            ...
                                            <option value="2" @if (old('meetingStatus', isset($meeting->meetingStatus) ? $meeting->meetingStatus : NULL) == 2) selected="selected" @endif>Completed</option>
                                            <option value="3" @if (old('meetingStatus', isset($meeting->meetingStatus) ? $meeting->meetingStatus : NULL) == 3) selected="selected" @endif>Missed</option>
