    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body list-grid">
                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllPermissionHead','Delete these Permission Head\'s details?','Are you sure you want to delete these Permission Head\'s details?');">
                                        Delete</button>
                ...
                <form method="post" id="deleteAllPermissionHead">

                    <div class="data-tables">
                        <table id="permissionHeadTable" class="text-center">
