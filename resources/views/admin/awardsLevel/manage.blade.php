    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body list-grid">
                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllAwardsLevel','Delete these Blood group\'s details?','Are you sure you want to delete these level of award\'s details?');">
                                        Delete</button>
                                ...
                                <div class="col-6 right-control">
                                    ...
                                    <a href="{{route('awardsLevel.index')}}">

                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Refresh</button>
                                    </a>

                                    <a href="{{route('awardsLevel.create')}}">
                                   
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Add Awards Level</button>
                                    </a>
                ...
                <form method="post" id="deleteAllAwardsLevel">

                    <div class="data-tables">
                        <table id="awardsLevelTable" class="text-center">
                                ...
                                <tr id="item{{$value->id}}">
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('awardsLevel.edit', $value->id)}}">Edit</a>
                                            <a class="dropdown-item" onclick="deleteRecord('{{$value->id}}','Delete this blood group details?','Are you sure you want to delete this awards Level details?');">Delete</a>
                                        </div>
                                    </td>
