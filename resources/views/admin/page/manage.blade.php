    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body list-grid">
                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllPage','Delete these Page\'s details?','Are you sure you want to delete these Page\'s details?');">
                                        Delete</button>
                                ...
                                <div class="col-6 right-control">
                                    ...
                                    <!-- <a href="{{ url('/console/page') }}"> -->
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Refresh</button>
                                    </a>

                                    <a href="{{route('page.create')}}">
                                    <!-- <a href="{{ url('/console/page/create') }}"> -->
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Add Page</button>
                                    </a>
                ...
                <form method="post" id="deleteAllPage">

                    <div class="data-tables">
                        <table id="pageTable" class="text-center">
                            ...
                            <tbody>
                                ...
                                <tr id="item{{$value->id}}">
                                    ...
                                    <input type="text" value=" {{route('pageDetail',['slug' => $value->slug])}}" readonly>
                                   </td>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('page.edit', $value->id)}}">Edit</a>
