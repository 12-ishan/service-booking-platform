                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllApplication','Delete these Application\'s details?','Are you sure you want to delete these Application\'s details?');">
                                        Delete</button>
                        ...
                        <table id="applicationTable" class="text-center">
                            ...
                            <tbody>
                                ...
                                <tr id="item{{$value->id}}">
                                    ...
                                    <td>@isset($value->application_number){{$value->application_number}}@else NA @endif</td>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('application.edit', $value->id)}}">Edit</a>
