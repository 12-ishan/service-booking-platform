$(document).ready(function () {
    ...
    $("#deleteAllRecess").on('submit', (function (e) {
        e.preventDefault();
        ...
        if (!length) {
            ...
            $("#messageBox").html('<p>No record selected please select Recess.</p>');
            return false;
        }

        $.ajax({
            url: '/admin/recess/destroyAll',
            type: 'post',
            ...
            success: function (result) {
                ...
                if (result.status) {
                    ...
                    $("#messageModal").modal('show');
                    $("#messageBox").html('<p>Recess information  deleted successfully</p>');
                }
    ...
    var table = $('#recessTable').DataTable({
        rowReorder: true,
        stateSave: true,
    ...
    table.on('row-reorder', function (e, diff, edit) {
        ...
        $.ajax({
            type: 'POST',
            url: '/admin/recess/updateSortorder',
            data: {
