$(document).ready(function () {
    ...
    // $("#deleteAllPlan").on('submit', (function (e) {
    //     e.preventDefault();
    ...
    //         $("#messageBox").html('<p>No record selected please select Plan.</p>');
    //         return false;
    //     }

    //     $.ajax({
    //         url: '/admin/plan/destroyAll',
    //         type: 'post',
    ...
    //                 });
    //                 $("#messageModal").modal('show');
    //                 $("#messageBox").html('<p>Plan information  deleted successfully</p>');
    //             }
...
/*
    table.on('row-reorder', function (e, diff, edit) {
        ...
        $.ajax({
            type: 'POST',
            url: '/admin/plan/updateSortorder',
            data: {
...
//     $("#deleteAlertBox").modal('show');
//     $('#deleteMessageHeading').html(planHeading);
//     $('#deleteMessageText').html(message);
