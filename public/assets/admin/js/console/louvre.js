$(document).ready(function () {
    ...
    $("#deleteAllLouvre").on('submit', (function (e) {
        e.preventDefault();
        ...
        if (!length) {
            ...
            $("#messageBox").html('<p>No record selected please select Louvre.</p>');
            return false;
        }

        $.ajax({
            url: '/admin/louvre/destroyAll',
            type: 'post',
            ...
            success: function (result) {
                ...
                if (result.status) {
                    ...
                    $("#messageModal").modal('show');
                    $("#messageBox").html('<p>Louvre information  deleted successfully</p>');
                }
    ...
    var table = $('#louvreTable').DataTable({
        rowReorder: true,
        stateSave: true,
    ...
    table.on('row-reorder', function (e, diff, edit) {
        ...
        $.ajax({
            type: 'POST',
            url: '/admin/louvre/updateSortorder',
            data: {
