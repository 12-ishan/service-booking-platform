$(document).ready(function () {
    ...
    $('#agencyId').on('change', function () {
        ...
        $.ajax({
            ...
            url: '/admin/artist/getAgentByAgnecyId/',
            dataType: 'json',
            headers: {
            ...
            success: function (result) {    
             ...
             $('#agentId').html(result.response);
             $('#agentId').prop('disabled', false); //makes select enabled
    ...
    $("#deleteAllArtist").on('submit', (function (e) {
        e.preventDefault();
        ...
        if (!length) {
            ...
            $("#messageBox").html('<p>No record selected please select artist.</p>');
            return false;
        }

        $.ajax({
            url: '/admin/artist/destroyAll',
            type: 'post',
            ...
            success: function (result) {
                ...
                if (result.status) {
                    ...
                    $("#messageModal").modal('show');
                    $("#messageBox").html('<p>Artist information  deleted successfully</p>');
                }
    ...
    table.on('row-reorder', function (e, diff, edit) {
        ...
        $.ajax({
            type: 'POST',
            url: '/admin/artist/updateSortorder',
            data: {
