$(document).ready(function () {
    ...
    $("#deleteAllAgent").on('submit', (function (e) {
        e.preventDefault();
        ...
        if (!length) {
            ...
            $("#messageBox").html('<p>No record selected please select agent.</p>');
            return false;
        }

        $.ajax({
            url: '/admin/agent/destroyAll',
            type: 'post',
            ...
            success: function (result) {
                ...
                if (result.status) {
                    ...
                    $("#messageModal").modal('show');
                    $("#messageBox").html('<p>Agent information  deleted successfully</p>');
                }
    ...
    table.on('row-reorder', function (e, diff, edit) {
        ...
        $.ajax({
            type: 'POST',
            url: '/admin/agent/updateSortorder',
            data: {
    ...
    $("#deleteAllModalButton").on("click", function () {
        ...
        $.ajax({
            ...
            error: function(jqXHR, textStatus, errorThrown) {
                admin.log(textStatus, errorThrown);
              }
        });
    });
}