$(document).ready(function () { 
    ...
    $("#deleteAllSalutation").on('submit', (function (e) {
        e.preventDefault();
        ...
        if (!length) {
            ...
            $("#messageBox").html('<p>No record selected please select salutation.</p>');
            return false;
        }

        $.ajax({
            url: '/admin/salutation/destroyAll',
            type: 'post',
            ...
            success: function (result) {
                ...
                if (result.status) {
                    ...
                    $("#messageModal").modal('show');
                    $("#messageBox").html('<p>Salutation information  deleted successfully</p>');
                }
    ...
    var table = $('#salutationTable').DataTable({
        rowReorder: true,
        stateSave: true,
    ...
    table.on('row-reorder', function (e, diff, edit) {
        ...
        $.ajax({
            type: 'POST',
            url: '/admin/salutation/updateSortorder',
            data: {
    ...
    $('.status').change(function () {
        ...
        $.ajax({
            ...
            url: '/admin/salutation/updateStatus',
            dataType: 'json',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
