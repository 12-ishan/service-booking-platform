$(document).ready(function () {
    ...
    $("#deleteAllHinge").on('submit', (function (e) {
        e.preventDefault();
        ...
        if (!length) {
            ...
            $("#messageBox").html('<p>No record selected please select Hinge.</p>');
            return false;
        }

        $.ajax({
            url: '/admin/hinge/destroyAll',
            type: 'post',
            ...
            success: function (result) {
                ...
                if (result.status) {
                    ...
                    $("#messageModal").modal('show');
                    $("#messageBox").html('<p>Hinge information  deleted successfully</p>');
                }
    ...
    var table = $('#hingeTable').DataTable({
        rowReorder: true,
        stateSave: true,
    ...
    table.on('row-reorder', function (e, diff, edit) {
        ...
        $.ajax({
            type: 'POST',
            url: '/admin/hinge/updateSortorder',
            data: {
