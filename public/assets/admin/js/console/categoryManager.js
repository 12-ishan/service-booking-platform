$(document).ready(function () {
    ...
    $("#deleteAllCategory").on('submit', (function (e) {
        e.preventDefault();
        ...
        if (!length) {
            ...
            $("#messageBox").html('<p>No record selected please select categories.</p>');
            return false;
        }

        $.ajax({
            url: '/admin/category/destroyAll',
            type: 'post',
    ...
    table.on('row-reorder', function (e, diff, edit) {
        ...
        $.ajax({
            type: 'POST',
            url: '/admin/category/updateSortorder',
            data: {
