$(document).ready(function () {
    ...
    $("#deleteAllMeeting").on('submit', (function (e) {
        ...
        if (!length) {
            ...
            $("#messageBox").html('<p>No record selected please select Meeting.</p>');
            return false;
        }
        $.ajax({
            url: '/admin/teacher-meeting/destroyAll',
            type: 'post',
            ...
            success: function (result) {
                ...
                if (result.status) {
                    ...
                    $("#messageModal").modal('show');
                    $("#messageBox").html('<p>Meeting information  deleted successfully</p>');
                }
    ...
    table.on('row-reorder', function (e, diff, edit) {
        ...
        // admin.log(JSON.stringify(arr));


        $.ajax({
            type: 'POST',
            url: '/admin/teacher-meeting/updateSortorder',
            data: {
    ...
    $('.status').change(function () {
        ...
        $.ajax({
            ...
            url: '/admin/teacher-meeting/updateStatus',
            dataType: 'json',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
    ...
    $('#programId').on('change', function () {
        ...
        $.ajax({
            ...
            url: '/admin/subject/getSubjectByProgramId',
            dataType: 'json',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            ...
            success: function (result) {
                ...
                $('#subjectId').prop('disabled', false); //makes select enabled
    ...
    $('#subjectId').on('change', function () {
        ...
        $.ajax({
            ...
            url: '/admin/topic/getTopicBySubjectId',
            dataType: 'json',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
    ...
    $('#programId').on('change', function () {
        ...
        $.ajax({
            ...
            url: '/admin/topic/getTeacherByProgramIDSubjectId',
            dataType: 'json',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            ...
            success: function (result) {
                ...
                $('#tutorId').html(result.response);
                $('#tutorId').prop('disabled', false); //makes select enabled
                $('.selectpicker').selectpicker('refresh');
...
function deleteRecord(id, title, message) {
    ...
    $("#deleteAllModalButton").on("click", function () {
        ...
        $.ajax({
            ...
            url: '/admin/teacher-meeting/destroy',
            dataType: 'json',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
