$(document).ready(function () {
    ...
    $("#deleteAllPannel").on('submit', (function (e) {
        e.preventDefault();
        ...
        if (!length) {
            ...
            $("#messageBox").html('<p>No record selected please select Pannel.</p>');
            return false;
        }

        $.ajax({
            url: '/admin/pannel/destroyAll',
            type: 'post',
            ...
            success: function (result) {
                ...
                if (result.status) {
                    ...
                    $("#messageModal").modal('show');
                    $("#messageBox").html('<p>Pannel information  deleted successfully</p>');
                }
    ...
    var table = $('#pannelTable').DataTable({
        rowReorder: true,
        stateSave: true,
    ...
    table.on('row-reorder', function (e, diff, edit) {
        ...
        $.ajax({
            type: 'POST',
            url: '/admin/pannel/updateSortorder',
            data: {
